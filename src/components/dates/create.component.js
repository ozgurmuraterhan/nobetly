                    ...
                    <FormControl>
                      <Select
                        ...
                        onChange={(selectedOption) => {
                          ...
                          seTstate({
                            ...state,
                            shiftStart: selectedOption.value,
                          });
                        }}
                      />

                      <FormHelperText>
                        Nöbet yazılmaya hangi saatte başlanacak? örn: 00:00
                      </FormHelperText>
                    </FormControl>
                  </FormGroup>
                </Grid>
                    ...
                    <FormControl style={{ zIndex: 12 }}>
                      <Select
                        ...
                        onChange={(selectedOption) => {
                          seTstate({
                            ...state,
                            shiftInterval: selectedOption.value,
                          });
                        }}
                      />
                      ...
                      <FormHelperText>
                        {' '}
                        Tek seferde kaç saat nöbet tutulacak?{' '}
                      </FormHelperText>
                    </FormControl>
