    ...
    getpostGroup();
     ...
     const onSubmit = (e) => {
        ...
        axios.post('http://localhost:5000/post/add', post)
          .then((res) => {
            if (res.data.variant == 'error') {
               enqueueSnackbar(t('Nöbet Yeri Eklenemedi') + res.data.messagge, { variant: res.data.variant });
            } else {
                ...
                <Grid item container md={12} className="panelGridRelative">
                  ...
                  <Card className="listViewPaper">
                    ...
                    <Grid container item sm={3} spacing={0}>
                      ...
                      <Grid container item sm={3} spacing={0} style={{paddingLeft:'10px'}}>
                        <FormGroup className="FormGroup" >
                          <FormControl>
                          <TextValidator
                              required
                            ...
                            />
                            <FormHelperText>{t('Bu nöbet yerinde kaç kişi nöbet tutacak?')}</FormHelperText>
                          </FormControl>
                        </FormGroup>
                      </Grid>
                      ...
                      <Grid container item sm={3} spacing={0}>
                        <FormGroup className="FormGroup">
                          <FormControl>
                            ...
                            />
                            <FormHelperText>{t('Nöbet Yerinin Dahili Numarası')}</FormHelperText>
                          </FormControl>
                        </FormGroup>
                      </Grid>
                      <Grid container item sm={3} spacing={0}>
